...
var celebs = ["Margaret Thatcher", "Nigel Farage", "Dwayne 'The Rock' Johnson", "PewdiePie", "Selena Gomez", "Mara Wilson", "The Prime Minister", "Neil Gaiman", "Kim Kardashian", "Daedalus Mole", "Taika Waititi", "Robert Downey Junior", "Jonathan Franzen", "Arin Hanson", "Richard Spencer", "Jeremy Corbyn", "Gordon Brown", "Alan Sugar", "Donald Trump", "Barack Obama", "George W. Bush", "Your Mate Adam", "Jon Jafari", "Markus Persson"];
...
var problems = ["Conundrum", "Case", "Affair", "Problem", "Wanking", "Referendum", "Decision", "Ultimatum", "Incident", "Resignation", "Discovery", "Rejection", "Cock-Up", "Disaster", "Campaign"];
